...
import { SafeAreaView, ScrollView, View, Text, Image, StyleSheet, TextInput, TouchableOpacity, FlatList, ActivityIndicator, Alert } from 'react-native';
            ...
            <ScrollView>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.commentInputContainer}>
                        ...
                        />
                        <TouchableOpacity style={styles.commentButton} onPress={handleAddComment} disabled={posting}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <View style={styles.commentContainer}>
                                    <Text style={styles.commentAuthor}>{item.author_name || "Unknown"}</Text>
